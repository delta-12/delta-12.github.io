            ...
            <div>
                ...
                <div className="container-lg mt-5 pt-5">
                    ...
                    <p style={{ fontWeight: "bold" }}>
                        Please visit <Link to="//sites.google.com/view/bicyclesafetyvest/home" target="_blank" rel="noopener noreferrer">https://sites.google.com/view/bicyclesafetyvest/home</Link> for a more detailed, comprehensive overiew of the Cycling Safety Vest.
                    </p>
                    <p>View the code for this project code on <Link to="//github.com/delta-12/cycling-safety-vest" target="_blank" rel="noopener noreferrer">Github</Link>!</p>
